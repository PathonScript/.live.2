<div class="fullflex">
	<h1 class="flex text-8xl text-white engtle">About me</h1>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 h-1/2 mt-10">
		<div class="grid p-2 mx-4">
			...
			<h1 class="text-white text-2xl script">
				...
				So I wrote my first line of code in C# for Unity.
			</h1>
		</div>
		<div class="grid p-2 mx-4">
			<h1 class="text-white text-2xl script">
				I can speak Thai, English, a bit Chinese. And a tiny Dutch.
			</h1>
		</div>
	</div>
